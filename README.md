...
> **Note:** If you have used the `♻️ automatic installer` via command line,<br>
> you **do not need** to manually add the `[power printer]` block below <br>
> (It has already been added automatically to your `moonraker.conf`).<br>
