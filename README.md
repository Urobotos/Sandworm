...
- <b>To preheat the Chamber when printing start:</b> `Filament profile --> Temperature --> Chamber --> Minimum: YOUR_VALUE °C` <br>
  ...
  > <span align="bottom"> ![note](images/info-git_light_gray.svg) **Note:** </span> For minimal chamber temp: Always set the minimum temperature in the printing chamber adequately considering the ambient temperature.
  ...
  > ![note](images/info-git_light_gray.svg) **Note:** Some temperature data (in °C) measured after about an hour of printing:<br>
