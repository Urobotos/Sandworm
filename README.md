...
> **Note:** If you have used the `♻️ automatic installer` via command line, you **do not need** to manually add the `[power printer]`<br>
> block below (It has already been added automatically to your `moonraker.conf`).<br>
